...
public class EditFontAdapter extends SelectableAdapter<EditFontAdapter.ViewHolder> {
    private static EditFontClickListener clickListener;
    ...
    public EditFontAdapter(Activity activity, EditFontClickListener clickListener2) {
        mContext = activity;
    ...
    public interface EditFontClickListener {
        void onItemClicked_Font(int i);
    }
    static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener {
         EditFontClickListener listener;
        RelativeLayout maain;
        TextView textView;



        public ViewHolder(View view, EditFontClickListener clickListener) {
            super(view);
            this.listener = clickListener;
            this.textView = (TextView) view.findViewById(R.id.textfont);
            this.maain = (RelativeLayout) view.findViewById(R.id.fondadpterid);
            ImageSizeUtility.setFountAdpterTextSize(this.maain, EditFontAdapter.mContext);
        ...
        public boolean onLongClick(View view) {
            EditFontClickListener clickListener = this.listener;
            return false;
        }
    }
}
